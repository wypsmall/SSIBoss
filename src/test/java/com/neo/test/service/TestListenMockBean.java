 ...
 */
@TestExecutionListeners({ DBUnitTestExecutionListener.class, MockitoDependencyInjectionTestExecutionListener.class })
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = "classpath*:spring/applicationContext*.xml")
public class TestListenMockBean extends AbstractJUnit4SpringContextTests {
